...
public class DayTest
{
	...
	@Test 
	//Test 1: findSpace debe retornar 10 si el dia ya cuenta con una cita a las 9am.
	public void testUno()
	{
		System.out.println("Test 1: Retorno 10");
		day1.makeAppointment(9, a1);
		int retorno = (int) day1.findSpace(new Appointment("Cita", 1));
	...
	@Test
	// Test 2: findSpace retorna -1 en un dia lleno
	public void testDos()	
	{
		System.out.println("Test 2: Retorno -1");
		fillDay();
		int retornoNegativo = (int)day1.findSpace(new Appointment("Cita", 2));
		day1.showAppointments();
		assertEquals(-1, retornoNegativo);
		System.out.println("----------------------------");
	}
}
